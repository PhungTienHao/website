...
class News extends Model
{
    ...
    public function insert()
    {
        $obj_insert = $this->connection
            ->prepare("INSERT INTO news(category_id, title, avatar,price,  summary, content, seo_title, seo_description, seo_keywords, status) 
    ...
    public function update($id)
    {
        $obj_update = $this->connection
            ->prepare("UPDATE news SET category_id=:category_id,price=:price, title=:title, avatar=:avatar,
